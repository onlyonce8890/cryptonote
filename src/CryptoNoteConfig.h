...
const uint64_t MONEY_SUPPLY                                  = 331210000000;
...
const char     CRYPTONOTE_NAME[]                             = "vcoin";
...
const int      P2P_DEFAULT_PORT                              = 20945;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 30475;
